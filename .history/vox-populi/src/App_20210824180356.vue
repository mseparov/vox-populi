<template>
  <div id="app">
    <nav id="nav" class="navbar navbar-expand-lg navbar-light">
      ...
      <a href="http://localhost:8080/"><img src="@/assets/Vox2.png" id="home_title" alt="" width="60"  class="d-inline-block align-text-centre logo"></a>
      <a href="http://localhost:8080/">&nbsp; Vox Populi</a>
      </div>
