  ...
  <div id="app">
    <nav id="nav" class="navbar navbar-expand-lg navbar-light">
      ...
      &nbsp; Vox Populi
          ...
          <router-link to="home" v-if="store.currentUser" id="nav_ele1" class="nav-link">&emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;Home</router-link>
          <router-link to="home" v-else id="nav_ele1" class="nav-link">Home</router-link>
