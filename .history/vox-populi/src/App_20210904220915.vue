  ...
  <div id="app">
    <nav id="nav" class="navbar navbar-expand-lg navbar-light">
      ...
      &nbsp; Vox Populi
          ...
          <router-link to="/" v-if="store.currentUser" id="nav_ele1" class="nav-link">&emsp;&emsp;&emsp;&emsp;&ensp;&nbsp;Home</router-link>
          <router-link to="/" v-else id="nav_ele1" class="nav-link">Home</router-link>
          ...
          <a href="#" v-if="store.currentUser" @click.preventz="logout()" id="nav_ele5" class="nav-link">Logout</a> 
