  ...
  <div id="app">
    <nav id="nav" class="navbar navbar-expand-lg navbar-light">
      ...
      &nbsp; Vox Populi
          ...
          <router-link to="/login" v-if="store.current" id="nav_ele3" class="nav-link">Login</router-link> 

          <router-link to="/signup" id="nav_ele4" class="nav-link">Signup</router-link> 
          
          <a href="#" @click="logout()" id="nav_ele5" class="nav-link">Logout</a> 
