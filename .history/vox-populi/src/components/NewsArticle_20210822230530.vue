<template>
  <div class="card">
      ...
      <form @submit.prevent="fetchSearchNews" class="d-flex" action="">
        <input v-model="searchword" class="form-control me-2" type="text" id="searchBar" placeholder="Search the web for news..." 
        v-if="!isBusy" v-on:keyup.enter="fetchSearchNews" aria-label="Search" >
      </form>
