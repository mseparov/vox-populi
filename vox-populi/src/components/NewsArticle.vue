  ...
  methods: {
    ...
    fetchSearchNews() {
      if (this.store.searchword !=='') {
        this.apiUrl = 'https://newsapi.org/v2/everything?q=' + this.store.searchword + '&pageSize=' + this.maxPerPage + '&apiKey=' + this.apiKey;
        this.isBusy = true;
    ...
    recognition.addEventListener("result", e => {
      ...
      if(transcript.includes("search")) {
        ...
        if (b == "") {
          ...
          this.apiUrl = 'https://newsapi.org/v2/everything?q=' + b + '&pageSize=' + this.maxPerPage + '&apiKey=' + this.apiKey;
          this.isBusy = true;
          this.resetData();
          this.fetchData();
        }
